...
raw_dots(pathway_day7_aEC_down, pathway_day1_vEC_down, pathway_day7_capEC_down, pathway_day7_vcapEC_down, pathway_day7_acapEC_down, intersection_pathways, "raw_dot_plot_pathway_day7_down.pdf")
```
...
```{r}
up_path <- c("Eicosanoid Signaling","RHO GTPase cycle","Estrogen Receptor Signaling","ERK/MAPK Signaling","Endothelin−1 Signaling", "Dopamine−DARPP32 Feedback in cAMP Signaling", "Serotonin Receptor Signaling", "CXCR4 Signaling","Glutaminergic Receptor Signaling Pathway (Enhanced)","Pancreatic Secretion Signaling Pathway")
down_path <- c("RAR Activation", "MHC class II antigen presentation", "Molecular Mechanisms of Cancer", "Pulmonary Fibrosis Idiopathic Signaling Pathway")

desired_order <- c("Eicosanoid Signaling","RHO GTPase cycle","Estrogen Receptor Signaling","ERK/MAPK Signaling","Endothelin−1 Signaling", "Dopamine−DARPP32 Feedback in cAMP Signaling", "Serotonin Receptor Signaling", "CXCR4 Signaling","Glutaminergic Receptor Signaling Pathway (Enhanced)","Pancreatic Secretion Signaling Pathway","RAR Activation", "MHC class II antigen presentation", "Molecular Mechanisms of Cancer", "Pulmonary Fibrosis Idiopathic Signaling Pathway")
